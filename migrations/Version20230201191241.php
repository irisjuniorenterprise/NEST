 ...
 */
final class Version20230201191241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE work_post (id INT AUTO_INCREMENT NOT NULL, engagement_post_id INT NOT NULL, sg_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_A349DDB53CA6A281 (engagement_post_id), INDEX IDX_A349DDB547A1BE9A (sg_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE workshop (id INT AUTO_INCREMENT NOT NULL, work_post_id INT NOT NULL, satisfaction_form_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_9B6F02C49E42BB0E (work_post_id), UNIQUE INDEX UNIQ_9B6F02C4C1C6FB27 (satisfaction_form_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
